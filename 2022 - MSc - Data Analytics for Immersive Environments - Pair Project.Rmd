...
output:
  ...
  word_document:
    toc: TRUE
subtitle: 'Descriptive & Inferential Analysis of a Virtual Jungian Sandplay VR Project'
---
...
6. Determine the 95% confidence interval for the population mean of each group, and the 95% confidence interval for the difference between the means of the two groups for a variable of your choice.
